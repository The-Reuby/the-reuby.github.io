    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal panel */}
          <div className="relative w-full max-w-5xl h-[600px] bg-white dark:bg-slate-900 shadow-2xl rounded-2xl overflow-hidden">
            {/* Close button */}
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 z-20 p-2 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-colors duration-200"
            >
                ...
                {currentMember.image ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-800">
                    <div className="text-center">
                      <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-slate-400 dark:bg-slate-600 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <p className="text-slate-500 dark:text-slate-400 font-medium">Team Member</p>
                            ...
                            {/* Content section */}
              <div className="lg:w-3/5 p-6 lg:p-8 flex flex-col h-full lg:h-auto">
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  {/* Role tag */}
                  <div className="inline-block px-4 py-2 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-full text-sm font-medium mb-6 w-fit">
                    {currentMember.role}
                  </div>

                  {/* Bio */}
                  <div className="flex-1 overflow-y-auto mb-6 max-h-72">
                    <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base lg:text-lg pr-2">
                      {currentMember.bio}
                    </p>
                  </div>
                </div>
